...
class HotelAdapter(private val onItemClick: (HotelItemResponse) -> Unit) :
    RecyclerView.Adapter<HotelAdapter.PlaceViewHolder>() {

    private val places: ArrayList<HotelItemResponse> = arrayListOf()
    ...
    inner class PlaceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(place: HotelItemResponse) {
    ...
    fun submitList(newList: List<HotelItemResponse>) {
        this.places.clear()
